...
class LuaScriptInterface
{
	...
	protected:
		...
		static int32_t luaItemUseInPosition(lua_State* L);
		...
		static int32_t luaMonsterExecuteSpell(lua_State* L);
		...
		static int32_t luaNpcSetSpeechBubble(lua_State* L); 10.36 */
